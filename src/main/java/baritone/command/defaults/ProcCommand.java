...
public class ProcCommand extends Command {
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The proc command provides miscellaneous information about the process currently controlling CoffinTone.",
                "",
                "You are not expected to understand this if you aren't familiar with how CoffinTone works.",
                "",
                "Usage:",
